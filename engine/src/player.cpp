...
Player::Player(Math::Vector3 startPosition) : Camera(startPosition), m_rigidBody(1.0f, Math::Vector3(0.0f, -50.0f, 0.0f)), m_collider(Math::Vector3(-1.0f, -2.5f, -1.0f), Math::Vector3(1.0f, 0.0f, 1.0f)), m_groundedCollider(Math::Vector3(-0.5f, -2.6f, 0.5f), Math::Vector3(0.5f, -2.4f, 0.5f)) {}
Player::~Player() {}
